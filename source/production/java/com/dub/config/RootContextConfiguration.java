...
@EnableJpaRepositories(
        basePackages = "com.dub.repositories",
        entityManagerFactoryRef = "entityManagerFactoryBean",
        transactionManagerRef = "jpaTransactionManager"
)
@ComponentScan(
        basePackages = {"com.dub.site", "com.dub.actors", 
        		"com.dub.directors", "com.dub.movies", 
        		"com.dub.advanced", "com.dub.users"},
        excludeFilters =
        ...
        AsyncConfigurer, SchedulingConfigurer
{
    ...
    public Jaxb2Marshaller jaxb2Marshaller()
    {
        ...
        marshaller.setPackagesToScan(new String[] { "com.dub.entities" });
        return marshaller;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean()
    {
        ...
        factory.setPackagesToScan("com.dub.entities");
